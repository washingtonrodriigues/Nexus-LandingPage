...
const SeventhSection = () => {
  return (
    <section className="bg-[#e4e4e4] flex justify-center px-[30px] gap-[30px] items-center">
      <div>
        <Image
      ...
      <div className="text-black flex flex-col gap-3 font-poppins w-[500px]">
        ...
        <div>
          <p className="italic text-[1.1rem]">
            "O nosso negócio é fazer crescer o seu!"
          </p>
          <span className="text-[#235581]">Washington Rodrigues</span>
        </div>
      </div>
    </section>
  );
